...
# Complete recursive_func function to satisfy documented behaviour


def measure_stack_limit():
    """Function that measures actual stack limit.

    This function calls a new recursive function to reach stack limit and
    counts the number of calls.

    It returns the number of recursive functions calls before stack limit is
    reached.
    """
